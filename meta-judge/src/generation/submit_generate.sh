...
#SBATCH --output=/mnt/proj1/fta-25-74/dev/master_thesis/src/karolina_testing/logs/gen/slurm-%j.out
#SBATCH --error=/mnt/proj1/fta-25-74/dev/master_thesis/src/karolina_testing/logs/gen/slurm-%j.err
...
DEFAULT_BATCH=128
DATA_COUNT=5 # Use -1 for all, or 50 for testing
